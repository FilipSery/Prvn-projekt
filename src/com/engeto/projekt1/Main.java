    ...
    public static void main(String[] args) throws StateException {
        ...
        for (StateInfo s : states1.getStatesFromFile()) {
            if (s.getFullIncomeTax() > 20 && s.isHasSpecialTax() == false) {
                ...
                outputFile1+= (s.getStateName() + " (" + s.getStateAbbreviation() + "): " + s.getFullIncomeTax() + " % ("+s.getLoweredIncomeTax()+"%)\n");
            }
        }
        System.out.println(line);

        System.out.println("výstup aplikace č. 5:");
        ...
        System.out.println("výstup aplikace č.6 - nahrání do souboru");
